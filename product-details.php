...
?>
    ...
    <div class="container-fluid productdetailscontainertab" id="overview">
        <div class="cart">
            <div class="row row1">
                <div class="col-md-6">
                    <img src="<?php echo $imgs[0]['path']; ?>" class="drift-demo-trigger" width="100%" id="ProductImg">
                     <div class="small-imgs">
                        <?php foreach ($imgs as $img) { ?>
                            <img src="<?php echo $img['path']; ?>" width="100%" class="small-img drift-demo-trigger">
                        <?php }
                ...
                <div class="col-md-6">
                    <h1 class="product-title"><?php echo ucwords($prod['title']); ?></h1>
                    <div class="reviews">
                    ...
                    <div id="product" class="product-inf">
                        <ul>
                            ...
                            <li><a href="#about" onclick="scrollTo(' #about');">Product Details</a></li>
                        </ul>
                        <div class="tabs-content">
                            <div id="Description">
                                <?php echo htmlspecialchars_decode($prod['description']); ?>
                            </div>
                            <!-- <div id="Details">
                ...
                <div class="leftsidedata col-md-9">
                    <div class="row commonrowpro">
                        <div class="col-md-12 commonproductdetails" id="price">
                            <h3>The 2017 Honda NSX Price in <i>Gurgaon</i></h3>
                    ...
                    <div class="row commonrowpro" style="display:none;">
                                ...
                                <?php foreach ($imgs as $img) { ?>
                                    ...
                                    <div class="col-lg-4 col-md-6 col-sm-6">
                                        <div class="single-gallery-item mb-30">
                                            <img src="<?php echo $img['path']; ?>" alt="Gallery Image" data-original="<?php echo $img['path']; ?>">
                                        </div>
                                    </div>
                                <?php }
