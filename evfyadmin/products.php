...
<div class="container-fluid">
  ...
  <div class="card shadow mb-4">
    ...
    <div class="card-body">
      <button class="btn btn-primary" onclick="markbest(this);">Mark Best Selling</button>
      <button class="btn btn-primary" onclick="markfeatured(this);">Mark Featured</button>
...
<div class="modal fade" tabindex="-1" role="dialog" id="deleteprodspopup">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
        <button type="button" class="btn btn-primary" id="delprodpopup_btn" data-id="" onclick="delProd();">Yes</button>
      </div>
    </div><!-- /.modal-content -->
  </div><!-- /.modal-dialog -->
</div><!-- /.modal -->
