...
<li><i class='fa fa-envelope-o'></i> <a href="#">hello@jamesanderson.com</a></li>
<li><i class='fa fa-phone'></i> <a href="#">+502 464 674</a></li>
<li><i class='fa fa-globe'></i> <a href="#" target="_blank">GT Road, Near Police Station (Main Ludhiana Delhi highway)</a></li>
</ul>
<ul class="social">
<li><a href="#" class="d-block" target="_blank"><i class='fa fa-facebook'></i></a></li>
<li><a href="#" class="d-block" target="_blank"><i class='fa fa-twitter'></i></a></li>
<li><a href="#" class="d-block" target="_blank"><i class='fa fa-instagram'></i></a></li>
<li><a href="#" class="d-block" target="_blank"><i class='fa fa-linkedin'></i></a></li>
...
<li><a href="#"><span>Give Reviews</span></a></li>
...
<td>Completed</td>
<td>lorem ipsum doler sit amet</td>
<td><i>₹</i>49.00 for <i>1</i> item</td>
...
<td>October 18, 2019</td>
<td>Completed</td>
<td><img src="assets/img/courses/1.jpg" class="img-fluid" alt="" title=""><span>lorem ipsum doler sit amet</span></td>
<td><a href="e-cycle.php" target="_blank" class="view-button">View</a></td>
</tr>
<tr>
<td>#074145O6</td>
<td>October 18, 2019</td>
...
<input type="text" class="form-control" id="slanme" name="slanme" required>
</div>
</div>
...
<input type="text" class="form-control" id="facebookid" name="facebookid" required>
</div>
</div>
...
<input type="text" class="form-control" id="twitterid" name="twitterid" required>
</div>
</div>
...
<input type="text" class="form-control" id="instagramid" name="instagramid" required>
</div>
</div>
...
<input type="text" class="form-control" id="linkedid" name="linkedid" required>
</div>
</div>
