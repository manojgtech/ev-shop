...
<!-- End Page Title Area -->
    ...
    <?php include 'include/product-detail-nav.php';?>
        ...
        <div class="cart">
            <div class="row row1">
                <div class="col-md-6">
                    <img src="assets/img/upcoming-images/product2.jpg" class="drift-demo-trigger" width="100%" id="ProductImg">
                    <div class="small-imgs">
                        <img src="assets/img/cars/kz1.jpg" width="100%" class="small-img drift-demo-trigger">
                        <img src="assets/img/cars/kz2.jpg" width="100%" class="small-img drift-demo-trigger">
                        <img src="assets/img/cars/kz3.jpg" width="100%" class="small-img drift-demo-trigger">
                        <img src="assets/img/cars/kz4.jpg" width="100%" class="small-img drift-demo-trigger">
<!--
...
-->
                ...
                <div class="col-md-6">
                    <h1 class="product-title">Kinetic Zoom</h1>
<!--
                    <div class="reviews">
...
-->
                        ...
                        <div class="col-md-12 commonproductdetails specificationidtab" id="gallery">
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-6">
                                <div class="single-gallery-item mb-30">
                                    <img src="assets/img/cars/kz5.jpg" alt="Gallery Image" data-original="assets/img/cars/kz5.jpg">
                                </div>
                            </div>
                            
                             <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="single-gallery-item mb-30">
                            <img src="assets/img/cars/kz6.jpg" alt="Gallery Image" data-original="assets/img/cars/kz6.jpg">
                        </div>
                    </div>
                    ...
                    <div class="row commonrowpro">
                        <div class="col-md-12 commonproductdetails specificationidtab" id="about">
                            ...
                            <p>Kinetic Zoom Electric scooter comes with a built-in cruise control switch. It doesn’t require any license or registration for its use. It comes with a Twin-LED headlight, aerodynamic design, huge under seat storage, speed mode switch and a lot more. Three beautiful color options are available in this scooter.</p>
                            
                            <h5 class="moredetailsproductshead">Cruise Control</h5>
                            <p class="extracontentdetails">A function usually found in four-wheelers, it helps one maintain a constant speed without having to keep a control on accelerator.</p>
                            
                            <h5 class="moredetailsproductshead">Suspension</h5>
                            <p class="extracontentdetails">The front suspension is telescopic and the rear is Coil Spring Three Steps Adjustable suspension.</p>
                            
                            <h5 class="moredetailsproductshead">Multi-functional Dashboard</h5>
                            <p class="extracontentdetails">It acts as a vehicle guide indicating- the battery levels, part-failure, trip meter, ready and parking indicator.</p>
                            
                            <h5 class="moredetailsproductshead">USB Port</h5>
                            <p class="extracontentdetails">No more waiting for your phones to get charged. Charge your phone on the go!</p>
                            
                             <h5 class="moredetailsproductshead">Smart remote key</h5>
                            <p class="extracontentdetails">Kinetic Zing comes with a remote key with four controls- anti-theft alarm, keyless entry, find my scooter alert, lock/unlock button.</p>
                        </div>
                    </div>
...
<p>Stunning design, very dedicated crew who welcome new ideas suggested by customers, nice support.</p>
    ...
    <ellipse transform="scale(-1) rotate(45 454 -421.3)" cx="174.5" cy="188" rx="12" ry="8.1" fill="#fff"/>
          ...
          <path d="M290.3 434.8c-1 3.4-5.8 5.2-11 3.9s-8.4-5.1-7.4-8.7c.8-3.3 5.7-5 10.7-3.8 5.1 1.4 8.5 5.3 7.7 8.6z" fill="#fff" opacity=".2"/>
                     ...
                     <?php include 'include/kinetic-zoom.php';?>
