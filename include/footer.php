    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="innercolumnproduct">
                        ...
                        <form class="form-horizontal" id="reqback-form1" method="post" action="" role="form">
                            <div class="form-group">
                                <input type="text" class="form-control" placeholder="Your Name" id="vname11" name="vname" required>
                            </div>

                            <div class="form-group">
                                <input type="email1" class="form-control" id="ecity11" name="ecity" placeholder="Your Mail" required>
                            </div>

                            <div class="form-group">
                                <input type="tel" id="mailuser11" name="mailuser" class="form-control" placeholder="Phone" required>
                            </div>
                            <div class="form-group">
                                <input type="text" class="form-control" id="rlocation11" name="rlocation1" placeholder="Location">

                            </div>
                            <div class="form-group" id="urmsg">
                            ...
                            <div class="form-group">
                                <input type="submit" id="reqformsubmit1" name="rsubmit" value="Submit">
                            </div>
                        </form>
      </div>
